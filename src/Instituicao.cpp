...
void Instituicao::setTurmasDisponiveis(vector<Turma> i_turmasDisponiveis)
{

};

void Instituicao::setProfessores(vector<string> i_professor)
{
...
vector<Turma> Instituicao::getTurmasDisponiveis()
{
