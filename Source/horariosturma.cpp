...
#include "ui_horariosturma.h"

// Construtor da classe HorariosTurma
HorariosTurma::HorariosTurma(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::HorariosTurma)
{
    ui->setupUi(this);
    ...
    connect(botaoConfirmar, &QPushButton::clicked, this, &HorariosTurma::onConfirmarClicked);
...
QMap<QString, QStringList> HorariosTurma::getHorariosSelecionados()
{
    return horariosSelecionados;
};

// Função chamada quando o botão Confirmar é pressionado
void HorariosTurma::onConfirmarClicked()
{
