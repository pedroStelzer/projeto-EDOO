...
namespace {
struct qt_meta_tag_ZN8CadastroE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8CadastroE = QtMocHelpers::stringData(
    "Cadastro",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8CadastroE[] = {
...
Q_CONSTINIT const QMetaObject Cadastro::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8CadastroE.offsetsAndSizes,
    qt_meta_data_ZN8CadastroE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8CadastroE_t,
        // Q_OBJECT / Q_GADGET
...
void *Cadastro::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8CadastroE.stringdata0))
